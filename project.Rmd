...
```{r}
bm <- as(train,"binaryRatingMatrix")
...
recs <- predict(pop_model, as(test, "binaryRatingMatrix") , type="topNList", n=2)
calcPredictionAccuracy(recs, getData(es, "unknown"), given=2)
```
